class SigVerifier {
    constructor(bnFactory) {
            ...
            wNAF(n, affinePoint) {
                ...
                for (let window = 0; window < windows; window++) {
                    ...
                    if (wbits === 0) {
                        ...
                        const cached = precomputes[offset + KMath.abs(wbits) - 1];
        ...
        this.verify = function verify(signature, msgHash, publicKey) {
...
SigVerifier.asyncDeps = {
    KMath: 'lib/math.js'
}

module.exports = SigVerifier;